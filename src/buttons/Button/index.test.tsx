...
import { defaultTheme, Button } from "../..";
...
describe("Button", () => {
  it("should render with default props", () => {
    ...
    expect(screen.getByRole("button")).toHaveStyle(`border: ${defaultTheme.border}`);
    expect(screen.getByRole("button")).toHaveStyle("border-color: transparent");
    expect(screen.getByRole("button")).toHaveStyle(`border-radius: ${defaultTheme.borderRadius}`);
    expect(screen.getByRole("button")).toHaveStyle(`color: ${defaultTheme.fontColor}`);
    expect(screen.getByRole("button")).toHaveStyle("font-weight: 500");
    expect(screen.getByRole("button")).toHaveStyle(`padding: ${defaultTheme.spacings.m}`);
  });
